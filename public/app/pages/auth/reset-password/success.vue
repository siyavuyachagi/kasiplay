      ...
      <div class="bg-white rounded-2xl shadow-2xl p-8">
        ...
        <div class="text-center mb-8">
          <div class="relative inline-block">
            <!-- Success Circle -->
            <div
              class="inline-flex items-center justify-center w-20 h-20 bg-green-100 rounded-full mb-4 animate-pulse">
              <icon
        ...
        <!-- Success Message -->
        <div
          class="bg-green-50 border border-green-200 rounded-lg p-4 mb-6 text-center">
        ...
        <nuxt-link
          to="/auth/login"
          class="w-full inline-flex items-center justify-center space-x-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl">
