...
import DefaultDesktopHeader from "~/components/layout/default-desktop-header.vue";
import DefaultMobileHeader from "~/components/layout/default-mobile-header.vue";
