          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                type="text"
                required
                class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent outline-none transition-all placeholder-gray-400 dark:placeholder-gray-500"
                placeholder="John" />
            </div>
            <div>
              <label
          ...
          <div>
            <label class="flex items-start cursor-pointer">
              <input
                ...
                type="checkbox"
                required
                class="w-4 h-4 text-blue-600 border-gray-300 dark:border-gray-600 rounded focus:ring-blue-500 dark:focus:ring-blue-400 cursor-pointer mt-1 bg-white dark:bg-gray-700" />
              <span
