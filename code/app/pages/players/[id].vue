        ...
        <div
          ...
          <div class="flex flex-col md:flex-row items-center gap-6">
            ...
            <div class="flex-1 text-center md:text-left">
              <div
                class="flex items-center justify-center md:justify-start space-x-2 mb-2">
          ...
          <!-- Season Stats -->
          <div
            class="grid grid-cols-2 md:grid-cols-5 gap-4 mt-6 pt-6 border-t border-white/20">
                  ...
                  <table class="w-full text-sm">
                    ...
                    <tbody
                      ...
                      <tr
                        ...
                        <td
                          class="px-4 py-3 text-center font-semibold text-green-600 dark:text-green-400">
                          {{ season.goals }}
                        </td>
                        <td
                          class="px-4 py-3 text-center font-semibold text-blue-600 dark:text-blue-400">
                          {{ season.assists }}
                        </td>
                        <td
                          class="px-4 py-3 text-center text-gray-600 dark:text-gray-400">
