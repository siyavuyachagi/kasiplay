<template>
  <div ref="dropdownRef" class="relative" @click-outside="closeDropdown">
    ...
    <transition
      ...
      <div
        v-if="isOpen"
        class="absolute mt-2 w-72 sm:w-80 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-20
...
const notifications = ref([
  { title: "System update completed", time: "2m ago", icon: "lucide:check-circle" },
  { title: "New follower: John Doe", time: "15m ago", icon: "lucide:user-plus" },
  { title: "Comment on your post", time: "1h ago", icon: "lucide:message-square" },
