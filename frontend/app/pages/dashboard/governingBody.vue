  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        >
          <div class="flex items-start justify-between mb-3">
            <div class="flex items-center space-x-3">
              ...
              >
                <icon 
                  :name="competition.type === 'league' ? 'lucide:table-2' : competition.type === 'cup' ? 'lucide:trophy' : 'lucide:award'" 
                  size="24" 
                  :class="competition.type === 'league' 
            ...
            <span
              ...
              :class="competition.status === 'active' 
    ...
    <div class="space-y-6">
      ...
      >
        ...
        <div class="space-y-3">
          ...
          <div class="flex items-center justify-between p-3 rounded-lg bg-yellow-50 dark:bg-yellow-900/20">
            <div class="flex items-center space-x-2">
              ...
              <span class="text-sm font-medium text-gray-900 dark:text-white">Suspended</span>
            </div>
          ...
          <div class="flex items-center justify-between p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20">
            <div class="flex items-center space-x-2">
              ...
              <span class="text-sm font-medium text-gray-900 dark:text-white">New This Month</span>
            </div>
        ...
        <button
          class="w-full mt-4 py-2 px-4 rounded-lg bg-purple-600 hover:bg-purple-700 text-white font-medium transition-colors"
        >
          View All Clubs
        </button>
      </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center space-x-1">
                <button
                  ...
                  title="Approve"
                >
                  <icon name="lucide:check" size="16" class="text-green-600 dark:text-green-400" />
                </button>
                <button
                  class="p-1 rounded hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors"
                  title="Reject"
                >
                  <icon name="lucide:x" size="16" class="text-red-600 dark:text-red-400" />
                </button>
                <button
                  class="p-1 rounded hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                  title="View Details"
                >
                  <icon name="lucide:eye" size="16" class="text-gray-600 dark:text-gray-400" />
                </button>
              </div>
            </div>
          </div>
  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
    ...
    >
      <div class="flex items-center justify-between mb-4">
        ...
        <span class="text-sm text-purple-600 dark:text-purple-400 font-medium cursor-pointer hover:underline">
          View Calendar
        </span>
      </div>
      ...
      <div class="space-y-3">
        ...
        >
          ...
          <div class="flex items-center justify-between">
            ...
            <span class="text-xs font-bold text-gray-500 dark:text-gray-400 mx-3">
              VS
            </span>
