<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div class="max-w-7xl mx-auto px-4">
        <div class="flex items-center justify-between h-14">
          ...
          <div class="flex items-center space-x-1 sm:space-x-2">
            ...
            <button
              class="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors relative">
              <icon
                name="lucide:bell"
                size="20"
                class="text-gray-700 dark:text-gray-300" />
    ...
    <!-- Live Match Banner -->
    <div
      class="sticky top-14 z-40 bg-gradient-to-r from-red-500 to-red-600 text-white shadow-lg">
      <div class="max-w-7xl mx-auto px-4 py-2">
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-2 sm:space-x-3">
            ...
            <span class="font-semibold text-xs sm:text-sm">LIVE</span>
            <span class="text-xs sm:text-sm">Chiefs 2-1 Pirates • 67'</span>
          </div>
          <nuxt-link
            to="/matches/live/1"
    ...
    <div class="max-w-7xl mx-auto px-4 py-4 sm:py-6">
      <div class="lg:grid lg:grid-cols-12 lg:gap-6">
        ...
        <aside
          ...
          <div class="p-4 space-y-4">
            ...
            <div
              class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
              <div
                class="p-3 border-b border-gray-200 dark:border-gray-700 flex items-center space-x-2">
                <icon
        ...
        <!-- Center Feed -->
        <main class="lg:col-span-6 mb-6 lg:mb-0">
          <div class="space-y-4">
            <!-- Create Post -->
            <div
            ...
            <div
              ...
              <div class="overflow-x-auto">
                <div
                  class="flex items-center space-x-1 p-2 border-b border-gray-200 dark:border-gray-700 min-w-max">
                  <button
            ...
            <div class="flex justify-center py-4">
              <button
                class="px-6 py-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                Load more posts
              </button>
            </div>
          </div>
