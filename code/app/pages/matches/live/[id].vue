        ...
        <div class="lg:col-span-2 space-y-4">
          ...
          <div class="bg-black rounded-xl overflow-hidden relative group">
            ...
            <div class="relative w-full" style="padding-bottom: 56.25%">
              ...
              <!-- Controls Overlay -->
              <div
                class="absolute inset-0 bg-linear-to-t from-black/80 via-transparent to-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-between p-6">
                <!-- Top Controls -->
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                      ...
                      <div
                        ...
                        <div
                          v-if="showSpeedMenu"
                          class="absolute right-0 bottom-full mb-2 bg-gray-900 rounded-lg shadow-xl py-2 min-w-20">
                          <button
          ...
          <div
            ...
            <div
              ...
              <div
                ...
                <div
                  class="w-8 h-8 rounded-full bg-linear-to-br from-blue-500 to-purple-600 flex items-center justify-center shrink-0">
