  ...
  <aside
    ...
    <div class="h-full overflow-y-auto scrollbar-hide">
      <div class="p-4 space-y-4 pb-20">
        ...
        <UiDefaultNavigationsCard />

        <!-- Announcements - Collapsible -->
        <UiDefaultAnnouncementsCard />

        <!-- Trending - Collapsible -->
        <UiDefaultTrendingTopicsCard />
      </div>
    </div>
  </aside>
...
const UiDefaultAnnouncementsCard = defineAsyncComponent(
  () => import("~/components/ui/default/cards/announcements-card.vue")
);
const UiDefaultNavigationsCard = defineAsyncComponent(
  () => import("~/components/ui/default/cards/navigations-card.vue")
);
const UiDefaultTrendingTopicsCard = defineAsyncComponent(
