            ...
            <article
              ...
              <div class="flex flex-col sm:flex-row gap-4">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div
                    class="flex justify-between sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div class="flex items-center space-x-2">
                      <div
...
const breadcrumbs = [{ label: "News", route: "/news", active: true }];
